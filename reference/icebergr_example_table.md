...
#> <icebergr_table>
#>   table:    db.events
#>   location: /tmp/RtmphfwJfM/icebergr-warehouse286d5a9be34f/db/events
#>   format:   v2
#>   snapshot: 2427142315992586267
#>   columns:  5
#>     id <int>
#>     event <string>
#>     amount <double>
...
#>   <chr>               <chr>             <dbl>
#> 1 8049107028303407803 append               50
#> 2 2427142315992586267 append               50
```
