...
feature_matrix <- function() {
  tibble::tribble(
    ...
    "Table properties (write)", FALSE, "Needs an update_properties transaction; out of scope for this version of icebergr",
    ...
    "Schema evolution", FALSE, "Out of scope for this version of icebergr",
    "Partitioned table creation", FALSE, "Out of scope for this version of icebergr",
    ...
    "Partition evolution", FALSE, "Out of scope for this version of icebergr",
    "Compaction / maintenance", FALSE, "Compaction needs a rewrite action iceberg-rust 0.10.0 does not have. Snapshot expiry it does have, and that one is out of scope for this version of icebergr",
    "dbplyr lazy verbs", FALSE, "Out of scope for this version of icebergr",
    "Table encryption", FALSE, "Not exposed by this version of icebergr",
