...
#> <icebergr_table>
#>   table:    db.events
#>   location: <tempdir>/icebergr-warehouse2bf4685a0e7d/db/events
#>   format:   v2
#>   snapshot: 4366375254843444825
#>   columns:  5
#>     id <int>
#>     event <string>
#>     amount <double>
...
#>   <chr>               <chr>             <dbl>         <dbl>
#> 1 1651109872489595050 append              200           200
#> 2 4366375254843444825 append              200           400
```
