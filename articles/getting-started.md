...
#> <icebergr_table>
#>   table:    db.events
#>   location: <tempdir>/icebergr-warehouse2ba41a6451b3/db/events
#>   format:   v2
#>   snapshot: 2500571348698771057
#>   columns:  5
#>     id <int>
#>     event <string>
#>     amount <double>
...
#>   <chr>               <chr>             <dbl>         <dbl>
#> 1 3940235951507823285 append              200           200
#> 2 2500571348698771057 append              200           400
```
